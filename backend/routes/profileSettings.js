        ...
        if (userIndex === -1) {
          return response.status(404).json({ message: "User not found" });
            ...
            if (!email && !enteredPassword) {
                ...
                return response.status(400).json({ message: "Please enter a new email or password to update your account. " });
            }
            else if (email) {
            ...
            if (enteredPassword) {
                try {
                    ...
                    if (passwordMatch) {
                        ...
                        return response.status(401).json({ message: "New password cannot be the same as old password." });
                    } else {
